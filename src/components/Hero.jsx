...
const Hero = () => {
  return (
    <section
      id="home"
      className={`flex md:flex-row -mt-[20px] flex-col ${styles.paddingY}`}
    >
      <div
        className={` flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}
      >
        <div className="flex flex-row items-center py-[6px] px4 bg-discount-gradient rounded-[10px] mb2">
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Our team of experts uses a methodolody to identify the credit cards
